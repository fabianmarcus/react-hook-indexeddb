...
export type { HookProps } from "./types/HookProps";
export type { UseIndexedDb } from "./types/UseIndexedDb";
export type { IndexedDbIndex } from "./types/IndexedDbIndex";

//--- Module Constants -----

const ERROR_NO_DB = new Error("IndexedDB is not initialized");

const ID_REGEX =
  /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;

const ID_UUID_PREFIX = "idb-";
